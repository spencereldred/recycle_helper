...
users = User.create([
  ...
  password: "makawao1",password_confirmation: "makawao1", radius: 5,
  ...
  password: "makawao2",password_confirmation: "makawao2",radius: 5,
  ...
  password: "makawao3",password_confirmation: "makawao3",radius: 5,
  ...
  password: "makawao4",password_confirmation: "makawao4", radius: 5,
  ...
  password: "makawao5",password_confirmation: "makawao5", radius: 5,
  ...
  password: "makawao6",password_confirmation: "makawao6", radius: 5,
  ...
  password: "kihei7",password_confirmation: "kihei7", radius: 5,
  address: "2100 Iliwai Loop", city: "Kihei", state: "HI", zipcode: "96753" },

  {username: "lahaina1", email: "eldredspencer@gmail.com", phone: "8082803758",
  function: "recycler", first_name: "Willie", last_name: "Mays",
  password: "lahaina1",password_confirmation: "lahaina1", radius: 5,
  ...
  function: "recycler", first_name: "Willie", last_name: "McCovey",
  password: "lahaina2",password_confirmation: "lahaina2",radius: 5,
  ...
  function: "recycler", first_name: "Juan", last_name: "Marchial",
  password: "lahaina3",password_confirmation: "lahaina3",radius: 5,
  ...
  function: "redeemer", first_name: "John", last_name: "Brodie",
  password: "lahaina6",password_confirmation: "lahaina6", radius: 5,
  ...
  function: "redeemer", first_name: "Gene", last_name: "Washington",
  password: "lahaina7",password_confirmation: "lahaina7", radius: 5,
  address: "100 Kelawea St", city: "Lahaina", state: "HI", zipcode: "96761" },

  {username: "kahului1", email: "eldredspencer@gmail.com", phone: "8082803758",
  function: "recycler", first_name: "Willie", last_name: "Mays",
  password: "kahului1",password_confirmation: "kahului1", radius: 5,
  ...
  function: "recycler", first_name: "Willie", last_name: "McCovey",
  password: "kahului2",password_confirmation: "kahului2",radius: 5,
  ...
  function: "recycler", first_name: "Juan", last_name: "Marchial",
  password: "kahului3",password_confirmation: "kahului3",radius: 5,
  ...
  function: "recycler", first_name: "Orlando", last_name: "Cepeda",
  password: "kahului4",password_confirmation: "kahului4", radius: 5,
  ...
  function: "recycler", first_name: "Gaylord", last_name: "Perry",
  password: "kahului5",password_confirmation: "kahului5", radius: 5,
  ...
  function: "redeemer", first_name: "John", last_name: "Brodie",
  password: "kahului6",password_confirmation: "kahului6", radius: 5,
  ...
  function: "redeemer", first_name: "Gene", last_name: "Washington",
  password: "kahului7",password_confirmation: "kahului7", radius: 5,
  address: "85 Onehee Avenue", city: "Kahului", state: "HI", zipcode: "96732" }
