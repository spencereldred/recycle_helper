...
#   password: "recycler1",password_confirmation: "recycler1", radius: 10,
#   address: "183 Pukulani St.", city: "Makawao", state: "HI", zipcode: "96768" },

#    {username: "recycler2", email: "spencereldred@yahoo.com", phone: "8082803758",
#   function: "recycler", first_name: "Willie", last_name: "McCovey",
#   password: "recycler2",password_confirmation: "recycler2",radius: 10,
#   address: "2841 Iolani St.", city: "Makawao", state: "HI", zipcode: "96768" },

#   {username: "recycler3", email: "spencereldred@yahoo.com", phone: "8082803758",
#   function: "recycler", first_name: "Juan", last_name: "Marchial",
#   password: "recycler3",password_confirmation: "recycler3",radius: 10,
#   address: "296 Liholani St.", city: "Makawao", state: "HI", zipcode: "96768" },

#   {username: "recycler4", email: "spencereldred@yahoo.com", phone: "8082803758",
#   function: "recycler", first_name: "Orlando", last_name: "Cepeda",
#   password: "recycler4",password_confirmation: "recycler4", radius: 10,
#   address: "2942 Aina Lani St.", city: "Makawao", state: "HI", zipcode: "96768" },

#   {username: "recycler5", email: "spencereldred@yahoo.com", phone: "8082803758",
#   function: "recycler", first_name: "Gaylord", last_name: "Perry",
#   password: "recycler5",password_confirmation: "recycler5", radius: 10,
#   address: "348 Nalani St.", city: "Makawao", state: "HI", zipcode: "96768" },

#   {username: "recycler6", email: "spencereldred@yahoo.com", phone: "8082803758",
#   function: "recycler", first_name: "Jack", last_name: "Clark",
#   password: "recycler6",password_confirmation: "recycler6", radius: 10,
...
#   password: "redeemer1",password_confirmation: "redeemer1", radius: 10,
#   address: "2741 Leolani Place", city: "Makawao", state: "HI", zipcode: "96768" },

#   {username: "redeemer2", email: "spencereldred@yahoo.com", phone: "8082803758",
#   function: "redeemer", first_name: "Ken", last_name: "Willard",
#   password: "redeemer2",password_confirmation: "redeemer2", radius: 10,
#   address: "2741 Leolani Place", city: "Makawao", state: "HI", zipcode: "96768" },

#   {username: "redeemer3", email: "spencereldred@yahoo.com", phone: "8082803758",
#   function: "redeemer", first_name: "Jerry", last_name: "Rice",
#   password: "redeemer3",password_confirmation: "redeemer3", radius: 10,
