...
users = User.create([
  ...
  password: "recycler2",password_confirmation: "recycler2",radius: 8,
  ...
  password: "recycler3",password_confirmation: "recycler3",radius: 8,
  ...
  password: "recycler4",password_confirmation: "recycler4", radius: 8,
  ...
  password: "recycler5",password_confirmation: "recycler5", radius: 8,
  ...
  password: "recycler6",password_confirmation: "recycler6", radius: 8,
  ...
  password: "redeemer2",password_confirmation: "redeemer2", radius: 8,
  address: "2741 Leolani Place", city: "Makawao", state: "HI", zipcode: "96768" },

  {username: "redeemer3", email: "spencereldred@yahoo.com", phone: "8082803758",
  function: "redeemer", first_name: "Jerry", last_name: "Rice",
  password: "redeemer3",password_confirmation: "redeemer3", radius: 8,
